...
- Разверуть структуру проекта и перейти в директорию `app/src/androidTest/java/ru.iteco.fmhandroid.ui/test`.
...
- Для запуска отдельных тестов выбрать нужный тестовый класс и повторить предыдущий шаг.
